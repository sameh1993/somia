<template>
  <section class="features section-padding-100-0">
    ...
    <div class="container">
      <div class="row">
        <div
          class="service-img-wrapper text-center how col-lg-6 col-md-12 col-sm-12"
        >
          <div class="image-box">
            <img
        ...
        <div
          class="services-column col-lg-6 offset-lg-0 col-md-10 offset-md-1 col-xs-10 offset-xs-1"
        >
          <!--Services Block Four-->
          <div class="services-block-four how">
            <div class="inner-box">
              ...
              <div class="text">
                ...
                Laudantium modi assumenda beatae provident non hic eum dolores
                natus, vitae, quae, facere perferendis.
              </div>
            </div>
          </div>
