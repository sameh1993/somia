<template>
  ...
  <section
    class="roadmap section-padding-100"
    style="
              ...
              <div class="data_cir-content">
                <span
                  ><span class="roadmap_content_info"
                    >Emergence and design of the idea</span
                  ><span class="roadmap_img"
                    ><img src="img/roadmap-icons/1.svg" alt="" /></span
                ></span>
              </div>
            </div>
            <div style="left: 20%" class="data_cir cir_1" data-date="Q3 2017">
              <div class="data_cir-content">
                <span
                  ...
                  ><span class="roadmap_img"
                    ><img src="img/roadmap-icons/2.svg" alt="" /></span
                ></span>
              </div>
            </div>
                ...
                <span
                  ><span class="roadmap_content_info"
                    ><ul>
                      <li>
                        <span>
                          start development of the ealier version and crypto
                          wallet version</span
                        >
                      </li>
                  ...
                  ><span class="roadmap_img"
                    ><img src="img/roadmap-icons/3.svg" alt="" /></span
                ></span>
              </div>
            </div>
            <div style="left: 40%" class="data_cir cir_3" data-date="Q1 2018">
              <div class="data_cir-content">
                <span
                  ...
                  ><span class="roadmap_img"
                    ><img src="img/roadmap-icons/4.svg" alt="" /></span
                ></span>
              </div>
            </div>
            <div
              style="left: 50%"
              class="data_cir cir_4 red_crc"
              data-date="Q2 2018"
            >
              <div class="data_cir-content">
                <span
                  ><span class="roadmap_content_info"
                    ><ul>
                      <li><span>Crowdsale</span></li>
                      <li><span>marketing campaign</span></li>
                      <li><span>listing to the major exchanges</span></li>
                    </ul> </span
                  ><span class="roadmap_img"
                    ><img src="img/roadmap-icons/5.svg" alt="" /></span
                ></span>
              </div>
            </div>
            <div
              style="left: 60%"
              class="data_cir cir_5 next"
              data-date="Q3 2018"
            >
              <div class="data_cir-content">
                <span
                  ><span class="roadmap_content_info"
                    ><ul>
                      <li><span>Crypto Wallet version release</span></li>
                  ...
                  ><span class="roadmap_img"
                    ><img src="img/roadmap-icons/6.svg" alt="" /></span
                ></span>
              </div>
            </div>
            <div
              style="left: 70%"
              class="data_cir cir_6 next"
              data-date="Q4 2018"
            >
              <div class="data_cir-content">
                <span
                  ><span class="roadmap_content_info"
                    ><ul>
                      ...
                      <li>
                        <span
                          >new partnerships and new marketplace support</span
                        >
                      </li>
                    </ul> </span
                  ><span class="roadmap_img"
                    ><img src="img/roadmap-icons/7.svg" alt="" /></span
                ></span>
              </div>
            </div>
            <div
              style="left: 80%"
              class="data_cir cir_7 next"
              data-date="Q1 2019"
            >
              <div class="data_cir-content">
                <span
                  ...
                  ><span class="roadmap_img"
                    ><img src="img/roadmap-icons/8.svg" alt="" /></span
                ></span>
              </div>
            </div>
            <div
              style="left: 90%"
              class="data_cir cir_8 next"
              data-date="Q2 2019"
            >
              <div class="data_cir-content">
                <span
                  ><span class="roadmap_content_info"
                    ><ul>
                      <li>
                        <span>
                          Platform integration to electronic marketplaces</span
                        >
                      </li>
                      <li><span>Zero Fee</span></li>
                    </ul> </span
                  ><span class="roadmap_img"
                    ><img src="img/roadmap-icons/9.svg" alt="" /></span
                ></span>
              </div>
            </div>
          </div>
